...
class Daiupbjj extends StatefulWidget {

  Daiupbjj() : super();
  @override
  _DaiupbjjState createState() => _DaiupbjjState();
}

class _DaiupbjjState extends State<Daiupbjj> {

  String nim = '0';
  bool visibility = false; //user jadi false
              ...
              children: <Widget>[
                new Container(
                  ...
                  child: new Column(
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: pertamakali? Row():Container(
                          child: hilangnav? Row():
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  SingleChildScrollView(
                            scrollDirection: Axis.horizontal,
                            child: dataketemu? Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: pertamakali? Text(""): Container(
